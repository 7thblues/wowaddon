...
-------------------------------------------------
	...
	local defaults = {
		...
		raid = {
			...
			group9 = { order="9", hide=true, classorder="WARLOCK", x=-274, y=-7, growth="TBLR", cols=1, rows=5, },  -- 9
			group10 = { order="10", hide=true, classorder="MAGE", x=-307, y=-7, growth="TBLR", cols=1, rows=5, },  -- 10
			group11 = { order="11", hide=true, classorder="MONK", x=-340, y=-7, growth="TBLR", cols=1, rows=5, },  -- 11
			group12 = { order="12", hide=true, classorder="DEMONHUNTER", x=-373, y=-7, growth="TBLR", cols=1, rows=5, },  -- 12
		},
		raidpet = { 
			w=33, h=12,
	...
	args = {
		...
		raid = {
			...
			args = {
				...
				group11 = { name=L["Header"]..11, type="group", order=70, args=groupopts, },
				group12 = { name=L["Header"]..12, type="group", order=71, args=groupopts, },
			},
		},
		raidpet = {
